...
async def get_dashboard_overview(
    ...
    return await service.get_dashboard_overview(DEFAULT_USER_ID, days=days)
...
async def get_platform_comparison(
    ...
    service = AnalyticsService(db)
    return await service.get_platform_comparison(DEFAULT_USER_ID, days=days)
...
async def get_content_performance(
    ...
    service = AnalyticsService(db)
    return await service.get_content_performance(DEFAULT_USER_ID, days=days)
...
async def get_temporal_analytics(
    ...
    service = AnalyticsService(db)
    return await service.get_temporal_analytics(DEFAULT_USER_ID, days=days)
...
async def get_sentiment_trends(
    ...
    service = AnalyticsService(db)
    return await service.get_sentiment_trends(DEFAULT_USER_ID, days=days)
...
async def get_growth_accuracy_report(
    ...
    service = AnalyticsService(db)
    return await service.get_growth_accuracy_report(DEFAULT_USER_ID, platform=platform)
