...
def upgrade() -> None:
    ...
    op.create_table(
        'post_media',
        sa.Column('id', GUID(), primary_key=True),
        sa.Column('post_id', GUID(), sa.ForeignKey('posts.id', ondelete='CASCADE'), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column('parent_comment_id', GUID(), sa.ForeignKey('comments.id'), nullable=True),
        sa.Column('text', sa.Text(), nullable=True),
        sa.Column('username', sa.String(length=100), nullable=True),
    ...
    op.create_table(
        'metrics',
        sa.Column('id', GUID(), primary_key=True),
        sa.Column('post_id', GUID(), sa.ForeignKey('posts.id', ondelete='CASCADE'), nullable=True),
        sa.Column('platform', sa.String(length=50), nullable=False),
