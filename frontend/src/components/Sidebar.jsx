...
export default function Sidebar({ activeTab, setActiveTab }) {
  ...
  return (
    <aside className="w-full lg:w-60 border-r border-[#1E293B] bg-[#07090E] flex flex-col flex-shrink-0 min-h-[calc(100vh-4rem)] font-['Plus_Jakarta_Sans']">
      {/* Brand Header */}
      <div className="p-4 border-b border-[#1E293B] flex items-center space-x-3">
        ...
        <div>
          ...
          <div className="text-[10px] text-slate-500 font-mono">Your social workspace</div>
        </div>
      </div>
