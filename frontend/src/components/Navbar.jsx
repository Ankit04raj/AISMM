...
export default function Navbar({ onGoHome, activeTab, onRefresh, onOpenAuth, currentUser, onLogout }) {
  ...
  return (
    <header className="h-16 border-b border-[#1E293B] bg-[#07090E]/90 backdrop-blur-md px-3 sm:px-6 flex items-center justify-between sticky top-0 z-40 font-['Plus_Jakarta_Sans']">
